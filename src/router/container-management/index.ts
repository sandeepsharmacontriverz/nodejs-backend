...
import { fetchCMSDashBoard, fetchCMSDashBoardAll, getMillsForFilter, updateTransactionStatus } from "../../controllers/container-management";
...
router.get('/transaction', fetchCMSDashBoard);
router.get('/transaction-all', fetchCMSDashBoardAll);
router.put('/transaction', updateTransactionStatus);
router.get('/get-mills', getMillsForFilter);
